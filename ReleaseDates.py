...
def valid_release_date(a_date, type):
    day = a_date.weekday()
    if type == "Album" and day == 0 :
        return True
    elif type == "Game" and day == 1 :
        return True
    elif type == "Show" and (day == 2 or day == 6) :
        return True
    elif type == "Movie" and day == 4 :
        return True
    elif type == "Play" and day == 5 :
        return True
    else :
        return False
